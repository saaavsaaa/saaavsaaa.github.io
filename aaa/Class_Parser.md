...
-----
 ...
    这个问题在多台服务器上都出现了，所以搜集多台的输出后可以确认这个规律，其实在下面代码的记录中也可以看出，如果有多个同名的类只会加载其中第一个，而选取的类是后加载的包里的。在不出问题的服务器上commons-codec-1.10.jar是在http-1.1.0.jar之后加载的，而出问题的服务器正好相反。
