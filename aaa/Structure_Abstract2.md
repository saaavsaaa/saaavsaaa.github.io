...
#### 双层伸展
技巧就是，对于双层单侧的形式(zig-zig或zag-zag)，g~p~v 不先旋转直接前驱 p，而是先旋转 p 的前驱 g，这样旋转结果就是对称形式的，比如zig-zig就会变成zag-zag，只有三层看不出来，如果是5层zig-zig形式的，例a-b-c-d-e，a为根，e是叶子，访问e，先旋转c，然后d，这时a-b-e-d-c，e是个转折
|  |  |  |  |  |  |  |
|:-:|:-:|:-:|:-:|:-:|:-:|:-:| 
|||||a|||
||||b|||| 
