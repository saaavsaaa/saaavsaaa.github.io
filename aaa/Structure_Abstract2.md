...
正向子序列和逆向子序列中有值冲突，设a、b冲突 1 ≤ a，b < M/2，就意味着 -a² ≡ b²(mod M)，a² + b² = n 可以整除 M，所以表长 M 一定是 n 的素因子，如果 M = 4k + 3，那 n 也可以被 M²(偶数次方) 整除，那么 n 最小也得是 M²，M² ≤ a² + b² 这于 a，b < M/2 冲突，所以 M = 4k + 3 的正逆两个子序列中不会有冲突   
